...
async function startBot() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') console.log('✅ NEW OFFICE MIND AI IS ONLINE!');
        if (connection === 'close') {
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        if (orderStates[sender]?.step === 'WAITING_FOR_ADDRESS') {
            ...
            // Match the exact format of your New Office Mind Admin Panel
            const newOfficeMindOrder = {
                userId: "whatsapp_" + customerWaNumber,
                userEmail: "whatsapp@newofficemind.com",
        ...
        // --- DYNAMIC MENU FEATURE ---
            ...
            let menuMessage = "🍔 *NEW OFFICE MIND LIVE MENU* 🍕\n\n";
        ...
        // --- GREETINGS ---
            ...
            await sock.sendMessage(sender, { text: "👋 *Welcome to New Office Mind!* \n\nI am your AI Assistant. Type *menu* to see our delicious food, or type *order [dish]* to buy instantly!" });
        }
        else if (text.includes("contact") || text.includes("call")) {
            await sock.sendMessage(sender, { text: "📞 *Contact New Office Mind:* \n\n- *Email:* support@newofficemind.com" });
        }
        else {
